...
fun <T : Any> Dropdown(
    ...
    var state by remember { mutableStateOf(menu) }
    ...
    DropdownMenu(
        ...
        AnimatedContent(targetState = state, transitionSpec = {
            ...
            DropdownContent(
                ...
                colors = colors,
                onParentClick = {
                    state = targetMenu.parent ?: throw IllegalStateException("Invalid parent menu")
                },
                onChildClick = { id ->
                    val child = targetMenu.getChild(id)
                    state = child ?: throw IllegalStateException("Invalid item id: $id")
                },
            )
        }
    }
